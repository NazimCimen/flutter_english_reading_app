...
/// Use case for fetching word details from local storage
class GetWordDetailFromFirestoreUseCase {
  ...
  /// Executes the use case to get word details from local storage with validation
  Future<Either<Failure, DictionaryEntry?>> call(String word) async {
    ...
    return _repository.getWordDetailFromFirestore(word);
  }
} 